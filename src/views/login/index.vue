<template>
    ...
    <div class="container-login">
      ...
      <el-card>
        ...
        <el-form ref='loginForm' :model='loginForm' :rules='loginFormrule' style="position:absolute,top:80px">
      ...
      callback()
       ...
       return{ loginForm:{
        ...
        mobile: [
          ...
          { required: true, message: '请输入手机号', validator: checkMobile,trigger: 'blur' }
          // 自定义校验
        ],
        code: [
...
if(val){
  ...
  this.$http.post('/authorizations',this.loginForm).then((res)=>{console.log('22')}).catch(()=>{ this.$message.error('手机号或验证码错误')});
